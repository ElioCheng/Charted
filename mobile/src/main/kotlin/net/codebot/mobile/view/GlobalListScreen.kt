...
@Composable
fun GlobalListScreen(viewModel: ViewModel, controller: Controller, authViewModel: AuthViewModel) {
    val scrollState = rememberScrollState()

    Box(modifier = Modifier.fillMaxSize()) {
        Text("Global Rankings", textAlign = TextAlign.Center, modifier = Modifier.fillMaxWidth().padding(10.dp))
        ...
        Column(
            ...
            val rankedTracks = viewModel.getGlobalList()
