...
class Login(val viewModel: ViewModel, val controller: Controller, val authViewModel: AuthViewModel, val navigator: TabNavigator) : Tab {
    ...
    override fun Content() {
        LoginPage(viewModel, controller, authViewModel, navigator)
    }
}